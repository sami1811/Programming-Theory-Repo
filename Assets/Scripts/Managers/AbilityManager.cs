...
public class AbilityManager : MonoBehaviour
{
    ...
    [SerializeField] private float maxFireRateMultiplier;
    ...
    [FormerlySerializedAs("OnUpgradeApplied")] [Header("Events")]
    ...
    {
        float maxMultiplier = GetMaxMultiplier(type);
        return _currentMultipliers[type] >= maxMultiplier;
    }
    
    /// <summary>
    /// Get the max multiplier for a specific upgrade type
    /// </summary>
    private float GetMaxMultiplier(UpgradeType type)
    {
        switch (type)
        {
            case UpgradeType.FireRate:
                return maxFireRateMultiplier;
            case UpgradeType.HealthRegen:
                return maxHealthRegenMultiplier;
    ...
    public void ApplyUpgrade(UpgradeData upgrade)
    {
        ...
        // Cap at max effect for this specific upgrade type
        float maxMultiplier = GetMaxMultiplier(type);
